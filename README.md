...
ColorPhage is a publication-oriented R package for scientific figure palettes. It combines curated discrete families, quantitative scales, ggplot2 helpers, and experimental support for large-category research visualizations.
...
Representative quantitative examples are now also included in the repository:

- [inst/gallery/quantitative_examples/heatmap.svg](inst/gallery/quantitative_examples/heatmap.svg)
- [inst/gallery/quantitative_examples/volcano.svg](inst/gallery/quantitative_examples/volcano.svg)
- [inst/gallery/quantitative_examples/enrichment.svg](inst/gallery/quantitative_examples/enrichment.svg)
